...
I wrote this function to interact with the `Country` endpoint of the Covid19 API.It returns all countries and associated provinces. The country_slug variable is used for country specific data.Some franchises have changed team names over the years as they change location. It takes one argument; `Country`, which can either be `"all"`, the full name of a team (e.g. `"New Jersey Devils"`), or the **franchise Id** (e.g. `23` for the New Jersey Devils).

```{r}
Country <- function(UProvince){
  ###
